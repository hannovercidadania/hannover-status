...
Última verificação: 23/08/2026, 12:50:26 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 4219 ms | 100.00% | 93.9% |
| Site Hannover | 🟢 de pé | 200 · 173 ms | 100.00% | 100.00% |
| Site Viena | 🟢 de pé | 200 · 266 ms | 100.00% | 100.00% |
...
- 🟢 **Banco de dados** · 816 ms · sonda de CPU dentro do teto
