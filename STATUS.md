...
Última verificação: 14/09/2026, 07:44:34 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 4525 ms | 100.00% | 100.00% |
...
- 🟢 **Inbox** · 115 ms · lista de conversas dentro do teto
- 🟢 **Anexos** · 68 ms · bucket de anexos respondendo
