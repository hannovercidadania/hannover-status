...
Última verificação: 25/08/2026, 14:21:57 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 4020 ms | 100.00% | 96.4% |
| Site Hannover | 🟢 de pé | 200 · 213 ms | 100.00% | 100.00% |
| Site Viena | 🟢 de pé | 200 · 339 ms | 100.00% | 100.00% |
| Site German Citizenship | 🟢 de pé | 200 · 226 ms | 100.00% | 100.00% |
| Site Werlang | 🟢 de pé | 200 · 242 ms | 100.00% | 100.00% |

## Peças do CRM na última medição

- 🟢 **Banco de dados** · 779 ms · sonda de CPU dentro do teto
- 🟢 **Inbox** · 822 ms · lista de conversas dentro do teto
