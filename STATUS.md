...
Última verificação: 23/08/2026, 14:59:59 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 3958 ms | 100.00% | 93.9% |
...
- 🟢 **Banco de dados** · 872 ms · sonda de CPU dentro do teto
- 🟢 **Inbox** · 792 ms · lista de conversas dentro do teto
- 🟢 **Anexos** · 467 ms · bucket de anexos respondendo
