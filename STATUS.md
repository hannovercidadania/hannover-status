...
Última verificação: 17/08/2026, 23:52:54 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 3475 ms | 90.5% | 96.3% |
| Site Hannover | 🟢 de pé | 200 · 404 ms | 100.00% | 100.00% |
| Site Viena | 🟢 de pé | 200 · 817 ms | 100.00% | 100.00% |
| Site German Citizenship | 🟢 de pé | 200 · 471 ms | 100.00% | 100.00% |
| Site Werlang | 🟢 de pé | 200 · 631 ms | 100.00% | 100.00% |

## Peças do CRM na última medição

- 🟢 **Banco de dados** — 784 ms
- 🟢 **Inbox** — 746 ms
- 🟢 **Anexos** — 161 ms
- 🟢 **WhatsApp (Z-API)**
- 🟢 **Conta Azul**
