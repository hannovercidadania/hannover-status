...
Última verificação: 25/08/2026, 07:02:41 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 4439 ms | 100.00% | 95.8% |
| Site Hannover | 🟢 de pé | 200 · 220 ms | 100.00% | 100.00% |
| Site Viena | 🟢 de pé | 200 · 471 ms | 100.00% | 100.00% |
...
- 🟢 **Banco de dados** · 982 ms · sonda de CPU dentro do teto
- 🟢 **Inbox** · 943 ms · lista de conversas dentro do teto
