...
Última verificação: 25/08/2026, 17:00:20 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 9886 ms | 100.00% | 96.4% |
...
| Site Werlang | 🟢 de pé | 200 · 495 ms | 100.00% | 100.00% |

## Peças do CRM na última medição

- 🟢 **Banco de dados** · 1364 ms · sonda de CPU dentro do teto
- 🟡 **Inbox** · 2637 ms · lista de conversas acima do teto
- 🟢 **Anexos** · 183 ms · bucket de anexos respondendo
