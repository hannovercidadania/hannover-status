...
Última verificação: 15/09/2026, 13:53:00 (Brasília).

| Sistema | Agora | Resposta | 24 h | 7 dias |
|---|---|---|---|---|
| CRM | 🟢 de pé | 200 · 5111 ms | 100.00% | 100.00% |
| Site Hannover | 🟢 de pé | 200 · 283 ms | 100.00% | 100.00% |
| Site Viena | 🟢 de pé | 200 · 423 ms | 100.00% | 100.00% |
| Site German Citizenship | 🟢 de pé | 200 · 503 ms | 100.00% | 100.00% |
| Site Werlang | 🟢 de pé | 200 · 517 ms | 100.00% | 100.00% |

## Peças do CRM na última medição

- 🟢 **Banco de dados** · 648 ms · sonda de CPU dentro do teto
- 🟢 **Inbox** · 118 ms · lista de conversas dentro do teto
- 🟢 **Anexos** · 44 ms · bucket de anexos respondendo
